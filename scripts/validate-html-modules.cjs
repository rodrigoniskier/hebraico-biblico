...
for(const [name,src] of [['61–90',runtime60],['91–118',runtime90]])if(!src.includes('document.currentScript')||!src.includes('document.write'))throw new Error(`carregamento ${name} não preserva a origem do mesmo diretório/CDN.`);
console.log('✓ Cadeia do navegador: HTML-base → 31–60 → 61–90 → 91–118.');
console.log('✓ Todos os módulos são carregados do mesmo diretório/CDN e na ordem validada.');
